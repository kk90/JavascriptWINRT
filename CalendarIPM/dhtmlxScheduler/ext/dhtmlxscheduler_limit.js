...
(function(){
	...
	*/
	...
	scheduler._get_block_by_config = scheduler._wrapUnsafeFunction(function(config) {
		var block  = document.createElement("DIV");
		if (config.html) {
			if (typeof config.html == "string")
				block.innerHTML = toStaticHTML(config.html);
			else
	...
	scheduler._render_marked_timespan = scheduler._wrapUnsafeFunction(function(options, area, day) {
